...
from handlers.article.article_handler import (
    ArticleListHandler,AddArticleHandler, AddCategoryTagHandler,
    DelCategoryTagHandler, ArticleContentHandler, AddCommentHandler,
    AddSecondCommentHandler, AddLikeHandler,SearchByCategoryTagHandler,
    AritlceModifyListHandler,ArticleModifyHandler, ArticleDeleteHandler
)
...
article_urls = [
    ...
    (r'/article/article_modify_manage', AritlceModifyListHandler),
